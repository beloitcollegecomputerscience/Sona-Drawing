...
//        System.out.println(Arrays.toString(coordinate.get(1)));//should be fails
        ...
        System.out.println(Arrays.toString(coordinate.get(0))); // should give {1, 2}
        // System.out.println(Arrays.toString(coordinate.get(1))); // should give {2, 2}
        // System.out.println(Arrays.toString(coordinate.get(2))); // should give {2, 3}
        // System.out.println(Arrays.toString(coordinate.get(3))); // should give {1, 3}
    }
}
